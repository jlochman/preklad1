...
\twoColls{
  ...
  Waste air will be exhausted through an exhaust duct below the ceiling. Rooms
  will be interconnected with exhaust duct by reticulated cartridges mounted in
  the ceiling. Amount of supplied air will be designed in the Quality lab room in
  ...
  changer and humidification chamber. This chamber will be equiped with steam pipe
  connected to a local ele/ctrical resistance-based steam producer.  
}
...
\twoColls{
  ...
  As soon as these controllers are set, controller settings on outlets are
  determined. 
...
\twoColls{
  ...
  50~Pa, optionally on operation of exhaust fans of technology. Fan speeds in
...
\twoColls{
  ...
  facade, where a weather resistant louver will be placed. 
...
\twoColls{
  ...
  blown out through swirl diffusers. Waste air will be suctioned out by ducts
...
\twoColls{
  ...
  building facade, where a weather resistant louver will be placed.  Waste air
...
\twoColls{
  ...
  and have fire resistance of 180 minutes.
...
\twoColls{ Jednotkou poz. 4.1 je teplotně upravovaný venkovní vzduch přiváděn
...
\twoColls{
  ...
  these controllers are set, controller settings on outlets are determined. 
...
\twoColls{
  ...
  resistant louver will be placed.  Waste air will be blown by AHU over the
...
\twoColls{
  ...
  Part Storage Room will be ensured by single
  AHU placed in AC machinery room on the 2nd floor.  Thermally conditioned
  outdoor air will be supplied through ventilation duct to indoor areas by
  diffusers. Inlet diffusers will be controlled by 24~V servomotors according to
  temperature in each room. Waste air will be exhausted by ducts leading below the
...
\twoColls{
  ...
  these controllers are set, controller settings on outlets are determined.  Fan
...
\twoColls{
  ...
  will be equipped with VAV controller allowing varying air flow rate. This
  controller will be set in order to ensure constant underpressure in room, max.
  50~Pa, optionally based on operation of exhaust fans of technology. Fan speeds in
  central unit will be controlled to ensure constant pressure in duct. 
...
\twoColls{
  ...
  Quality Room
  will be ensured by two AHUs and one adsorption dehumidifying unit.
  All units will be placed in AC machinery room on the 2nd floor. MAU and
  ...
  regulated air through a duct to climatized areas, where it will be blown by swirl
  diffusers.
  Waste air will be exhausted by a duct initiating in each individual room.
  Amount of supplied air will be designed in the MAF Quality room in order to
  lead away heat load to comply with LEGO Standards in the remaining areas.
...
\twoColls{
  ...
  controller settings on outlets are determined.  Fan speeds in central unit
...
\twoColls{
  ...
  controller settings on outlets are determined.
...
\twoColls{
  ...
  through diffusers.  Waste air will be exhausted by exhaust ducts leading below
...
\twoColls{
  ...
  The amount of supplied air is designed to ensure 1 air exchange per hour up
...
\twoColls{
  ...
  For each separate PER a separate equipment was devised.  Outdoor air will be
  suctioned in by a duct ventilator above the roof of the building and led through
