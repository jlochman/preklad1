...
\twoColls{
  ...
  which will be installed in suspended ceiling.  Waste air will be exhausted by ducts
  leading above the suspended ceiling.  Ventilated office will be interconnected with
  exhausted suspended ceiling by reticulated cartridges mounted in the suspended ceiling. 
...
\twoColls{
  ...
  amount of outdoor air supplied to offices is calculated to 50~m3/h per person
  and for meeting rooms to 80~m3/h per person. There will always be at least 4
...
\twoColls{
  ...
  Cooling of offices will be ensured by central AHU (variable air volume system –
  ...
  a requirement of minimal hygienic ventilation.  In meeting room, there will be a
...
\twoColls{
  ...
  ceiling and will blow air through perforated ceiling grids. Second
  line will be led above food serving and its outlets will be equipped with
  grease separating diffusers installed in suspended ceiling.
...
\twoColls{
  ...
  Amount of supplied air is designed to ensure 10 air exchanges per hour 
  to lead heat load away. Assuming 13,500~m3/h of supply air and
...
\twoColls{
  ...
  indoor areas, where it will be blown through swirl diffusers mounted in
...
\twoColls{
  ...
  exhausted from individual rooms with diffusers mounted in the suspended ceiling and
  blown by fan over the roof of the building. Replacement air will be
...
\twoColls{
  ...
  room. As soon as these controllers are set, controller settings on outlets
  will be determined. Fan speeds in central AHUs will be set to ensure constant
...
\twoColls{
  ...
  calculated to 50~m3/h per person. There will always be at least 4 air
  exchanges per hour.
...
\twoColls{
  ...
  diffusers, which will be installed in suspended ceiling. Waste air will be exhausted by
  ...
  controllers with water-based air heaters, whereas exhaust ducts will be
...
\twoColls{
  ...
  The amount of supplied outdoor air is calculated to 50~m3/h per person. There
...
\twoColls{
  ...
  Outdoor air will be suctioned in by a duct ventilator above the roof of the
